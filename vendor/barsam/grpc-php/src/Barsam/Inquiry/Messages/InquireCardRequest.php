 ...
 *
 * Generated from protobuf message <code>barsam.inquiry.messages.InquireCardRequest</code>
 */
class InquireCardRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * The card number to inquire
     *
