 ...
 *
 * Generated from protobuf message <code>barsam.payment.messages.RequestResponse</code>
 */
class RequestResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.barsam.payment.enums.PaymentType type = 2;</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Barsam\Payment\Enums\PaymentType::class);
        $this->type = $var;
